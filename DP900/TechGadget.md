...
## **5. EXERCÍCIO PRÁTICO PARA AULA**

**Cenário:** Black Friday na TechGadget

1. **Parte 1 (Relacional):**
   - Simular 100 pedidos simultâneos no Azure SQL
   - Mostrar bloqueios e transações

2. **Parte 2 (Não Relacional):**
   - Armazenar logs de cliques do Black Friday no Cosmos DB
   - Consultar produtos mais visualizados

3. **Parte 3 (Analytics):**
   - Criar pipeline no Data Factory para consolidar dados
   - Construir dashboard no Power BI mostrando:
     - Vendas por hora
     - Produtos mais vendidos
     - Tráfego do site

4. **Parte 4 (Decisão Arquitetural):**
   - Dado um novo requisito (chatbot com histórico de conversas)
   - Os alunos devem escolher: Cosmos DB vs. SQL Database vs. Table Storage
   - Discussão: Por que Cosmos DB é melhor para este caso?

---

## **6. PERGUNTAS PARA REVISÃO (BASEADO NO CENÁRIO)**

1. **Para dados de pedidos transacionais, qual serviço você escolheria e por quê?**
   - (A) Azure Cosmos DB
   - (B) Azure SQL Database ✓
   - (C) Azure Table Storage

2. **Onde armazenaria as fotos dos produtos?**
   - (A) Azure SQL Database
   - (B) Azure Blob Storage ✓
   - (C) Azure Synapse Analytics

3. **Como orquestraria o pipeline diário de ETL?**
   - (A) Azure Functions
   - (B) Azure Data Factory ✓
   - (C) Power BI

4. **Para análise de 2 anos de dados históricos, qual serviço?**
   - (A) Azure SQL Database
   - (B) Azure Cosmos DB
   - (C) Azure Synapse Analytics ✓
...
## **7. COMO USAR ESTE CENÁRIO NA AULA**

| **Minutos** | **Atividade** | **Link com Cenário** |
|-------------|---------------|----------------------|
| 0-15 | Introdução | Apresentar a TechGadget e seus problemas |
| 15-60 | Módulo 1 | Mostrar pedidos transacionais no SQL Database |
| 60-120 | Módulo 2 | Demo: Carrinho no Cosmos DB + fotos no Blob Storage |
| 120-180 | Módulo 3 | Pipeline do Data Factory para Black Friday |
| 180-240 | Módulo 4 | Dashboard Power BI com vendas da TechGadget |
| 240-270 | Módulo 5 | Revisão: Tomar decisões arquiteturais como CTO da TechGadget |
